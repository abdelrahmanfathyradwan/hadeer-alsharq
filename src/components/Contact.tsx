  ...
  const contactCards = [
    {
      ...
      label: t.contact.info.phone1Label,
      value: "0565633240",
      href: "tel:0565633240",
      color: "road",
    },
    {
      ...
      label: t.contact.info.phone2Label,
      value: "0568515785",
      href: "tel:0568515785",
      color: "road",
    },
        ...
        >
          {contactCards.map((card, i) => (
            <a
              ...
              className="group flex items-center gap-4 glass-card rounded-xl p-4 md:p-5 hover:border-road-500/30 transition-all duration-300 hover:-translate-y-0.5"
            >
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                  card.color === "green"
                    ...
                    : "bg-road-500/10 text-road-500 group-hover:bg-road-500/20"
                }`}
              >
                {card.icon}
              </div>
              <div>
                <div className="text-xs text-asphalt-500 font-medium mb-0.5">
                  {card.label}
                </div>
                <div className="text-base font-bold text-white group-hover:text-road-400 transition-colors" dir="ltr">
                  {card.value}
                </div>
              </div>
            </a>
