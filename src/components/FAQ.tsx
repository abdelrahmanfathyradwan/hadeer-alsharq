...
export default function FAQ({ locale = "ar" }: { locale?: Locale }) {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {t.faq.items.map((item, i) => (
            <div
              key={i}
              className="glass-card rounded-2xl overflow-hidden transition-all duration-500 opacity-100 translate-y-0"
            >
              <button
